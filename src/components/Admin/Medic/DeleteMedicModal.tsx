...
import { deleteMedicById } from "@/api/MedicAPI";



export default function DeleteMedicModal() {
    ...
    const deleteMedic = queryParams.get("deleteMedic") || "";
    const showModal = deleteMedic === "true" ? true : false;
    ...
    const deleteMedicMutation = useMutation({
        mutationFn: deleteMedicById,
        onError: (error) => toast.error(error.message || "Error al eliminar el médico"),
        onSuccess: (data) => {
            toast.success(data.message);
    ...
    const handleForm = async (data: CheckPasswordForm) => {
        ...
        await deleteMedicMutation.mutateAsync(medicId);
    };
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle shadow-xl transition-all">
                                <div className="flex items-center justify-between">
                                    ...
                                    >
                                        <FaTrash className="inline mr-2" /> Eliminar Medico
                                    </Dialog.Title>
                                    <button
                                        type="button"
                                ...
                                <div className="mt-4">
                                    <p className="text-sm text-gray-500">
                                        ¿Estás seguro de que deseas eliminar este medico? Esta acción no se puede deshacer.
