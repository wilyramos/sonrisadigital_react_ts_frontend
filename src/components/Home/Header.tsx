                ...
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-4">
                    ...
                    >
                        ...
                        >
                            <Link
                                to="/servicios"
                                className="bg-teal-500 text-white px-4 py-1 md:px-8 md:py-3 rounded-full shadow hover:bg-teal-600 transition duration-300 ease-in-out font-semibold flex items-center text-sm md:text-base"
                            >
                            ...
                            <Button
                                ...
                                target="_blank"
                                className="bg-green-500 text-white px-4 py-1 md:px-8 md:py-3 rounded-full shadow hover:bg-green-600 transition duration-300 ease-in-out font-semibold flex items-center text-sm md:text-base"
                            >
                                Agendar Cita
